...
/**
 * TODO: find a way to handle error from NodeClientRequest
 * Error: connect ECONNREFUSED ::1:80
    at TCPConnectWrap.afterConnect [as oncomplete] (node:net:1555:16)
   Emitted 'error' event on NodeClientRequest instance at:
    at NodeClientRequest.emit (supergood-js/src/interceptor/NodeClientRequest.ts:77:22)
 */
