...
interface InfoPayloadType {
    config: ConfigType;
    request?: Request;
    response?: Omit<Response, 'buffer' | 'size' | 'textConverted' | 'timeout' | 'headers'>;
...
interface LoggerType {
    error: (message: string, payload: InfoPayloadType, error: Error, extra?: any) => void;
...
export type { HeaderOptionType, RequestType, ResponseType, EventRequestType, InfoPayloadType, LoggerType, ConfigType, ErrorPayloadType, BodyType, SensitiveKeyMetadata, RemoteConfigType, EndpointConfigType, RemoteConfigPayloadType, RemoteConfigPayloadTypeV2, MetadataType, TelemetryType, SupergoodContext, TagType, ProxyConfigType };
